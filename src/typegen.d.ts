...
export type ConfigNames = 'antfu/imports/rules' | 'antfu/javascript/setup' | 'antfu/javascript/rules' | 'antfu/stylistic/rules' | 'antfu/typescript/setup' | 'karl/typescript/parser' | 'karl/typescript/rules'
